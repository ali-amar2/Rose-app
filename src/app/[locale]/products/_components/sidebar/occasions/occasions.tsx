...
export default function ProductFilters() {
  ...
  // Extract current filters from URL (Multi-select support)
  ...
  return (
    <>
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-bold text-zinc-900">Occasion</h3>
        <button
      ...
      <div className="w-full   bg-white max-h-80 overflow-auto ">
        {/* Occasions Section */}
        <div className="">
